...
$rebate = query("SELECT * FROM wallet WHERE kategori = 'REBATE' AND input!=0 AND email!='spp21indonesia@gmail.com' ORDER BY id DESC");
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Data Share Rebate</h4>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Detail Share Rebate</h4>
                                                                ...
                                                                <form action="models/input.php" method="post"
                                                                    ...
                                                                    <input type="hidden" id="bagi-rebate"
                                                                        name="bagi-rebate" class="form-control"
                                                                        value="bagi-rebate" readonly="">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="mb-3">
                                                                                    <label for="jumlahrebate"
                                                                                        class="form-label">Total Rebate
                                                                                        (Rp.)</label>
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        id="jumlahrebate"
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            name="Bagi-Rebate">Input Rebate</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
